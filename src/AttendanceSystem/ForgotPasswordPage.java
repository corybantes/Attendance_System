...
public class ForgotPasswordPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String myuser = "root";
        String mysql = "Gorybantesstoresdata.00";
        String email = jTextField1.getText();
        String query = "Select password from admin where email = '"+email+"';";
        try{
            Connection con = DriverManager.getConnection(url,myuser,mysql);
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query);
            if (rs.next()){
                JOptionPane.showMessageDialog(this, "Password is "+rs.getString("password"));
            }else{
